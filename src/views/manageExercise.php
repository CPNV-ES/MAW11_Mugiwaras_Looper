                        ...
                        <?php foreach ($categorizedExercises[$status] as $exercise): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($status != 'Closed' && $status != 'Answering'): ?>
                                        <a href="/exercises/updateStatus?id_exercise=1&newStatus=Answering" class="status-update-link" data-id="<?= $exercise['id_exercise'] ?>" data-status="Answering">
